  ...
  return (
    <section id="become-a-partner" className="py-20 bg-[#f5f4e8]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl font-bold mb-16 text-[#5a6b23]">Get Involved</h2>

        <div className="grid md:grid-cols-2 gap-16">
          {/* Volunteer Section */}
          <div>
            <div className="flex flex-col items-start gap-3 mb-6">
              <Heart className="w-10 h-10 text-[#5a6b23]" />
              <h3 className="text-2xl font-bold text-[#5a6b23]">Volunteer with Heart</h3>
            </div>
          ...
          <div>
            <div className="flex flex-col items-start gap-3 mb-6">
              <Handshake className="w-10 h-10 text-[#5a6b23]" />
              <h3 className="text-2xl font-bold text-[#5a6b23]">Become a Partner</h3>
            </div>
            <p className="text-gray-800 leading-relaxed">
